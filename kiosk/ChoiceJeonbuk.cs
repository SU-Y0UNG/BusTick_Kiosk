...
namespace Kiosk
{
    public partial class ChoiceJeonbuk : Form
    {
        Seat s1;
        Time t1;
        public ChoiceJeonbuk()
        {
            InitializeComponent();
        }
        ...
        private void Chungbuk_Click_1(object sender, EventArgs e)
        {
        ...
        private void Daejeon_Click_2(object sender, EventArgs e)
        {
